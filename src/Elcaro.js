...
function Elcaro() {
  ...
  const contractAddress = '0x0AB45D8EaF53bc255fb72edc9Af471Fa39FD5D01';
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">{currentBankName} Bank Contract Project</span> 💰
      </h2>
      <section className="customer-section px-10 pt-5 pb-10">
        <div className="mt-7 mb-9">
          <form className="form-style">
            ...
            <button className="btn-purple" onClick={deposityMoneyHandler}>Deposit Money In ETH</button>
          </form>
        </div>
